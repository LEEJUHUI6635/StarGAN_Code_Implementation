...
class Solver(object):
    ...
    def denorm(self, x): # tanh [-1, 1] -> [0, 1]
    ...
    # Custom Dataset에서 label을 one-hot vector로 만들었기 때문에 필요 x
    ...
    def train(self):
        ...
        for i in range(start_iters, self.num_iters):
            ...
            try:
                x_real, label_org = next(data_iter) # batch 학습을 위해, dataloader를 바로 사용해도 된다.
            except:
                data_iter = iter(data_loader)
